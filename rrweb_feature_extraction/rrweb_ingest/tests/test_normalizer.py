...
class TestNormalizeChunk:
    ...
    def test_empty_events_list_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Cannot create chunk from empty event list"):
    ...
    def test_event_missing_timestamp_raises_error(self):
        ...
        with pytest.raises(KeyError, match="Event at index 1 missing required 'timestamp' field"):
