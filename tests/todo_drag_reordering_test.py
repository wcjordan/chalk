...
from helpers.todo_helpers import (add_todo, assert_todo_descriptions, drag_todo, wait_for_todo)
...
def test_todo_drag_reordering(page, todo_prefix):
    ...
    assert_todo_descriptions(page, todo_prefix, [f'{todo_prefix} #{idx}' for idx in range(7)])
    ...
    assert_todo_descriptions(page, todo_prefix, [
        f'{todo_prefix} #0',
        f'{todo_prefix} #6',
        f'{todo_prefix} #1',
        f'{todo_prefix} #2',
