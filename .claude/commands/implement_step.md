Please read `spec.md` to get an idea of the project, then read `prompt_plan.md` to get an idea of the steps to complete the project.  Complete the step described below according to the inputs.
