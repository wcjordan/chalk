...
class TestCLIMatchChunk:
    ...
    def create_sample_chunk(
        self, chunk_id: str, has_matching_interaction: bool = True
    ) -> dict:
    ...
    def test_single_file_processing(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            chunk_data = self.create_sample_chunk(
    ...
    def test_directory_processing(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            chunk1_data = self.create_sample_chunk(
            ...
            chunk2_data = self.create_sample_chunk(
